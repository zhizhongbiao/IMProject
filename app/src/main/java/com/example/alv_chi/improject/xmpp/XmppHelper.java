...
//
//    //          initialize XMPP
//    private void initial() throws ConnectException {
////        Log.e(TAG, "initial: IP="+ DataManager.getDataManagerInstance().getServerIP());
//        xmppConfigBuilder = XMPPTCPConnectionConfiguration.builder()
////                .setHost(Constants.AppConfigConstants.OPEN_FIRE_SERVER_IP)
//                .setHost(DataManager.getDataManagerInstance().getServerIP())
...
//
//    @Override
//    public synchronized void login(String userName, String password,boolean isManuallyLogin) throws LoginNameOrPasswordException, ConnectException {
//
...
//            xmppTcpConnectionInstance.login(userName, password);
//            setStatu(xmppTcpConnectionInstance, Presence.Type.available, Constants.KeyConstants.IS_ONLINE);
...
//        xmppTcpConnectionInstance.disconnect(unavailablePresence);
//    }
//
//
//    @Override
...
//        return ChatManager.getInstanceFor(xmppTcpConnectionInstance);
//    }
//
//
//    public Roster getRoster() throws ConnectException {
////        return Roster.getInstanceFor(getXMPPConnectionInstance());
//        return Roster.getInstanceFor(xmppTcpConnectionInstance);
//    }
//
//
...
//        return VCardManager.getInstanceFor(xmppTcpConnectionInstance);
//    }
//
//
...
//        return AccountManager.getInstance(xmppTcpConnectionInstance);
//    }
//
//    /**
